...
record Album(int Id, string Title, string Artist, double Price, string Image_url)
{
     public static List<Album> GetAll(){
         var albums = new List<Album>(){
            ...
            new Album(7, "Purple Deploy", "Prince and the containers", 12.99, "https://aka.ms/albums-vnetlogo"),
            new Album(8, "Listen without listeners", "George Maven", 14.99, "https://aka.ms/albums-containerappslogo"),
            new Album(9, "Reptiablity", "The Webhooks", 12.99, "https://aka.ms/albums-vnetlogo")
         };
